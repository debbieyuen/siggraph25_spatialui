...
<Callout type="info" emoji="💡">
  <strong>Note:</strong> To read more about how to adjust the fit of the Apple Vision Pro, complete setup, and navigate applications, please visit  <strong><a href="https://support.apple.com/guide/apple-vision-pro/get-started-with-apple-vision-pro-tan489cfe222/visionos">Getting started with the Apple Vision Pro</a></strong>!
</Callout>
...
|----------------------|------------------------------------------------------|-------------------------------------------|
| Lecture Slides       | Shareable link to the session’s presentation         | [Keynote Slides](https://www.icloud.com/keynote/02eepvFmQKOgzKiU1DCtgm1mA#sig25_spatialui)                             |
...
| Xcode 16.3            | visionOS project built to the Apple Vision Pro as a prototype application | [Website](https://developer.apple.com/documentation/Xcode-Release-Notes/xcode-26-release-notes)                                        |
