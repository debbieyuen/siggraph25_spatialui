...
<iframe width="100%" height="500" src="https://www.youtube.com/embed/R19fWD-zwXY?si=8cPi2Fa9Z-jDVAgx" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
Once you are done, you may click on the `Export/File Share` button. Clicking on the the button the first time takes `eight .pngs` and `one .json` file of your drawing. 

<iframe width="100%" height="500" src="https://www.youtube.com/embed/ZKikVUeMFn8?si=huwhj8JTzDBpr5zc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

The 8 snapshots are automatically taken with a virtual camera and then rendered with texture and lighting to make it look three-dimensional. 
